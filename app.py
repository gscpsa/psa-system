...
<meta name='viewport' content='width=device-width, initial-scale=1.0'>
    ...
    <style>
        ...
        /* --- UI ONLY: brand + portal landing form update --- */
        .brand-logo {{
            line-height:.9;
            letter-spacing:2px;
    ...
    <body>
        <div class="topbar">
            <div class="brand brand-logo">
                <div class="brand-main">GIANT</div>
                <div class="brand-sub">SPORTS CARDS</div>
            </div>
