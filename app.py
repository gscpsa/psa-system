    ...
    <style>
        * {{
        ...
        .portal-landing {{
            ...
            padding:24px;
            background:
                linear-gradient(135deg, rgba(6,16,13,.88), rgba(15,81,50,.62)),
...
def portal():
    ...
    <div class="portal-landing">
        <div class="portal-card">
            ...
            <p>Enter your phone number and last name to view your PSA grading status.</p>
            <form method="post">
